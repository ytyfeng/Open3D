...
function(import_3rdparty_library name)
    cmake_parse_arguments(arg "PUBLIC;HEADER" "INCLUDE_DIR;LIB_DIR" "SHARED_LIBRARIES;LIBRARIES" ${ARGN})
    if(arg_UNPARSED_ARGUMENTS)
    ...
    if(arg_SHARED_LIBRARIES)
        foreach(arg_LIBRARY IN LISTS arg_SHARED_LIBRARIES)
            #NOTE: Following needs some work for headless
            #message(STATUS "Linking against shared lib " ${arg_LIBRARY})
            ...
            target_link_libraries(${name} INTERFACE ${arg_LIBRARY})
    ...
    if(arg_LIBRARIES)
        ...
        foreach(arg_LIBRARY IN LISTS arg_LIBRARIES)
            message(STATUS "Linking against static lib " ${arg_LIBRARY})
...
if(ENABLE_GUI)
    ...
    import_3rdparty_library(3rdparty_filament HEADER
        ...
        SHARED_LIBRARIES ${filament_SHARED_LIBRARIES}
    )
